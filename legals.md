...
**Unofficial Project**
This project is an independent, open-source application developed for interoperability purposes. It is **not** affiliated with, endorsed by, or associated with the manufacturer of the device or its official application.
