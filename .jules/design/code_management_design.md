...
*   **Mechanism**:
    ...
    *   **Single Use Codes**:
        ...
        *   (Limitation: If logs don't contain the specific code, we might only be able to show "Used" if a single-use code was used *after* this code was created, which is a heuristic).
