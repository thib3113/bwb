...
This prevented the application from showing a "Pending Actions" state immediately upon loading, and coupled the _planning_ of tasks too tightly with the _execution_.
...
2. **Online Task Execution**:
   - The `TaskContext` (specifically `processPendingTasks`) remains responsible for _executing_ these tasks.
